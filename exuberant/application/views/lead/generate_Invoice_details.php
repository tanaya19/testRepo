...
<div class="container">
  ...
  <?php //print_r($data)  ;?>
	<table>
		...
		<form name="payoutform" id="payoutform" action ="<?php echo base_url('index.php/lead/updateInvoicePaid/'.$invoiceId); ?>" method="POST">
		...
		<div class="row">
			...
			<div class="col-sm-3 col-md-6" style="background-color: lightyellow;">
				...
				<div><h5>Bank Slab=Rs.<?php echo $slab_rate;?></div>
